...
**Sound Adjuster** is a Firefox browser extension that allows you to control audio levels and stereo balance for individual tabs.
...
## Features
- **Volume Control**: Adjust the audio gain for each tab.
- **Stereo Balance**: Shift audio to the left or right channel.
